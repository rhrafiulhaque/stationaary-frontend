const Features = () => {
  return (
    <div className="max-w-6xl mx-auto  my-[40px] ">
      <h2 className="text-3xl text-center font-bold text-gray-800 my-[80px]">
      ...
      <div className="grid lg:grid-cols-3 md:grid-cols-2 gap-12">
        <div className="text-center">
          ...
          <p className="text-gray-600 text-sm">
            Crafted with top-tier materials for durability and smooth
            performance.
          </p>
        </div>
        ...
        <div className="text-center">
          ...
          <p className="text-gray-600 text-sm">
            Sustainably sourced stationery that’s kind to the planet
          </p>
        </div>
        ...
        <div className="text-center">
          ...
          <p className="text-gray-600 text-sm">
            Elegant and modern designs to add a touch of class to your desk.
          </p>
        </div>
        ...
        <div className="text-center">
          ...
          <p className="text-gray-600 text-sm">
            From pens to planners, find everything you need in one place.
          </p>
        </div>
        ...
        <div className="text-center">
          ...
          <p className="text-gray-600 text-sm">
            Beautiful stationery that makes the perfect gift for any occasion.
          </p>
        </div>
        ...
        <div className="text-center">
          ...
          <p className="text-gray-600 text-sm">
            Enjoy effortless writing with our specially designed pens and
            notebooks.
          </p>
        </div>
      </div>
